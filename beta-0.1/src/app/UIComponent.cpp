...
UIComponent::UIComponent(int x, int y, int width, int height, bool selectable, ControlType extra_control)
        : x(x), y(y), width(width), height(height), selectable(selectable), extra_control(extra_control)
        , active(true) {}
